...
prompt de changuito:
enlista cada producto con su nombre  y marca con su precio por unidad y toda su información que suele estar al lado del precio, así con data precio del catalogo
y agrúpalos todos los productos asi Producto | Marca | Presentación | Precio unidad | Precio kg/L


**Categorías sugeridas para agrupar (ajustables a tu cartelera)**

- **Lácteos**: leche, queso, yogurt, crema, mantequilla
- **Abarrotes**: cereal, arroz, pasta, enlatados, salsas, azúcar, café, té
- **Bebidas**: refrescos, jugos, agua, bebidas deportivas, alcohol (si aplica)
...
- **Limpieza del hogar**
- **Higiene personal**
- **Bebés**: pañales, fórmula, toallitas
- **Mascotas**
- **Salud / farmacia** (si aparece)
- **Otros / temporada**
